...
if (isset($_POST['update_admin'])) {
    ...
    $query = "UPDATE user SET user_first_name='$user_first_name',user_middle_name='$user_middle_name',user_last_name='$user_last_name', user_email='$user_email', admin_station='$user_station',user_phone_number='$user_phone_number',user_status='$user_status',user_role='$user_role' WHERE user_id='$user_id'";
    $query_run = mysqli_query($conn, $query);
...
if (isset($_POST['delete_admin'])) {
    ...
    if ($query_run) {
        $res = [
            'status' => 200,
            'message' => 'Admin Deletd Successfully'
        ];
        echo json_encode($res);
        return false;
    } else {
