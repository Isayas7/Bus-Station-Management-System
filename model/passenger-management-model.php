...
if (isset($_POST['save_passenger'])) {
    ...
    $passenger_from = mysqli_real_escape_string($conn, $_POST['passenger_froms']);
    $passenger_to = mysqli_real_escape_string($conn, $_POST['passenger_tos']);
...
if (isset($_POST['update_passenger'])) {
    ...
    $passenger_email = mysqli_real_escape_string($conn, $_POST['passenger_email']);
    $passenger_phone = mysqli_real_escape_string($conn, $_POST['passenger_phone']);
    $passenger_from = mysqli_real_escape_string($conn, $_POST['passenger_frome']);
    $passenger_to = mysqli_real_escape_string($conn, $_POST['passenger_toe']);
